  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      if (typeof speakTrustChain === "function") {
        speakTrustChain(
          "Warning. Threat matrix scans indicate anomaly vectors intersecting Block B and Security Core."
        );
      }
    }, 1000);
    ...
    <div className="mt-24 max-w-7xl mx-auto px-4 font-mono select-none">
      ...
      <div className="relative h-[600px] overflow-hidden rounded-3xl border border-cyan-500/10 bg-gradient-to-br from-[#02040a] via-[#041224] to-[#010206] shadow-2xl">
        ...
        <motion.div
          ...
          className="absolute left-1/2 top-1/2 w-[400px] h-[400px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-cyan-500/5 pointer-events-none"
        />
        ...
        <motion.div
          ...
          className="absolute left-1/2 top-1/2 w-[250px] h-[250px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-blue-500/5 pointer-events-none"
        />
        ...
        <div className="absolute bottom-6 right-6 bg-black/60 border border-red-500/10 rounded-xl px-4 py-3 backdrop-blur-md">
          <p className="text-red-400 text-xs font-black tracking-widest">
            INTEGRITY MITIGATION ACTIVE
          </p>

          <p className="text-gray-500 text-[10px] mt-0.5">
            Isolating anomaly vectors on Node B
          </p>
        </div>
      </div>
    </div>
