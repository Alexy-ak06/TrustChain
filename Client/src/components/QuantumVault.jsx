...
export default function QuantumVault() {
  // ⚡ FIX: Pre-calculate static coordinates to prevent dots from snapping on re-render
  const securityDots = useMemo(() => {
    return [...Array(14)].map((_, i) => ({
      id: `dot-${i}`,
      top: `${15 + Math.random() * 70}%`, // Restrict to ring bounds to avoid border spill over
  ...
  const leftTelemetry = useMemo(() => [
    { id: "tele-1", label: "Encryption Strength", value: "4096-BIT" },
    { id: "tele-2", label: "Threat Resistance", value: "99.98%" },
    { id: "tele-3", label: "Consensus Integrity", value: "VERIFIED" },
  ], []);

  const rightLogs = useMemo(() => [
    { id: "log-1", text: "Quantum firewall initialized" },
    { id: "log-2", text: "AI anomaly defense active" },
    { id: "log-3", text: "Biometric consensus authenticated" },
    { id: "log-4", text: "Zero-trust verification enabled" },
  ], []);
  ...
  return (
    <div className="mt-32 relative overflow-hidden rounded-[38px] border border-cyan-500/20 bg-[#02050a]/60 backdrop-blur-2xl p-6 md:p-12 font-mono select-none">
      ...
      {/* Structural Background Radial Gradients */}
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col xl:flex-row items-center justify-between gap-12 xl:gap-20">
          ...
          {/* CENTER MECHANICAL VAULT MODULE */}
          <div className="relative flex items-center justify-center w-[320px] h-[320px] md:w-[450px] md:h-[450px] order-1 xl:order-2 my-8 xl:my-0">
            ...
            {/* INTERMEDIATE COUNTER-ROTATING RING */}
            <motion.div
              animate={{ rotate: -360 }}
            ...
            {/* FLOATING POSITIONALLY-STABLE CORE SECURITY PARTICLES */}
